...
public class DepositController {
	...
	public PageResult  findPage(int page,int rows){			
		return depositService.findPage(page, rows);
	}
	 ...
	 */
	@RequestMapping("/add")
	public Result add(@RequestBody XxDeposit deposit){
		try {
	...
	public Result update(@RequestBody XxDeposit deposit){
		try {
	...
	public PageResult search(@RequestBody XxDeposit deposit, int page, int rows  ){
		return depositService.findPage(deposit, page, rows);		
	}
